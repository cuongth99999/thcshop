            ...
            <div class="section" id="feature-product-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        ...
                        ?>
                        <li>
                            <a href="?mod=products&action=detail&product_id=<?php echo $item['id']; ?>" title="" class="thumb">
                                <img src="<?php echo $item['thumbnail']; ?>">
                            </a>
                            <a style="
    overflow: hidden;
    white-space: nowrap;
    text-overflow: ellipsis;" href="?mod=products&action=detail&product_id=<?php echo $item['id']; ?>" title="" class="product-name"><?php echo $item['product_name']; ?></a>
                            <div class="price">
